...
{
    public partial class FRM_SellPrices : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (dgvBill.Rows.Count > 0)
            {
                ...
                else
                {
                    ...
                    {
                        con.Open();
                        OleDbCommand cmd = new OleDbCommand("insert into Sell_BillOrder (Date_B_Bill,Total,Description,Cus_Name,Discount,Seller_N,S_AmountPay,S_AmountRem)" +
                        ...
                        string LastIDBill = "";
                        OleDbDataAdapter da = new OleDbDataAdapter("select TOP 1 S_Bill_ID from Sell_BillOrder ORDER BY S_Bill_ID DESC", con);
                        ...
                        for (int i = 0; i < dgvBill.Rows.Count; i++)
                        {
                            ...
                            con.Open();
                            OleDbCommand cmd1 = new OleDbCommand("insert into S_D_BillOrder (Pro_Name,Qty,S_Price,S_Bill_ID)" +
                        ...
                        MessageBox.Show("تمت عملية حفظ عرض الاسعار بنجاح");
