...
{
    public partial class FRM_BuyBillRem : Form
    {
        ...
        private void txtQty_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Enter)
            {
                ...
                {
                    MessageBox.Show("يحب تحديد السعر لهذا المنتج");
                    return;
                }
            ...
            if (dgvBill.Rows.Count > 0)
            {
                ...
                else
                {
                        ...
                        OleDbCommand cmd = new OleDbCommand("insert into Buy_Bill (Date_B_Bill,Total,Sup_Name,Discount,Description,Buyer_N,B_AmountPay,B_AmountRem)" +
                            "values ('" + txtDate.Text + "','" + txtTotal.Text + "','" + txtSupName.Text + "','" + txtDiscount.Text + "','مرتجع من المورد" + txtDiscription.Text + "'," +
                        ...
                        FRM_BuyBillRem bb = new FRM_BuyBillRem();
                        con.Open();
                        OleDbCommand cmd3 = new OleDbCommand("insert into BoxInfo (Proc_type,Proc_Date,Deposit,Withdraw,Discreption)" +
                            "values ('مرتجع فاتورة شراء','" + txtDate.Text + "','" + txtAmountPay.Text + "','0','" + bb.Text + "')", con);
