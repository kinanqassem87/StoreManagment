...
{
    public partial class FRM_RemovePro : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    if (int.Parse(dt.Rows[0][1].ToString()) < int.Parse(txtQty.Text)) 
                    {
                        MessageBox.Show("لا يوجد عدد القطع المحدد من المنتج \n الكمية الموجودة هي " + dt.Rows[0][1].ToString() + "");
                    }
                    else
                    {
